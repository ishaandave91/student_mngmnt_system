...
class AgeCalculator(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('img/age_icon.png'))
        grid = QGridLayout()
        ...
        grid.addWidget(calculate_btn, 2, 0, 1, 2)   # row 2, column 0, span = 1 row & 2 columns
    ...
    def calculate_age(self):
        ...
        self.output_label.setText(f"{self.name_line_edit.text()}'s current age is {age}")
